...
function get_records(page)
{
	...
	$.ajax({
		url : base_url+"Welcome_API/get_ibm_projects",
		method : "POST",
		...
		success:function(data){
			...
			if(data.records!='')
			{
				...
				$.each(data.records, function(i){
                    ...
                    html += '<div class="row">';
                    html += '<div class="col-8 col-sm-12">';
                    ...
                    html += '</div>';
                    html += '<div class="btn-class"><a href="'+base_url+'ibm-project/'+row.badge_id+'"><button class="btn btn-aws btn-km" >Enroll</button> <img class="know-btn" src="'+base_url+'aws/images/know-more.png" alt="know-more"></a></div>';
                    html += '</div>';
                    html += '</div>';
                    html += '</div>'; 
                    html += '</div>';
